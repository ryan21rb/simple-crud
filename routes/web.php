...
Route::get('/mobil/{id_mobil}', [MobilController::class, 'delete'])->name('mobil.delete');
...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/', [SesiController::class, 'login']); // Adjust the URL based on your form submission
});
